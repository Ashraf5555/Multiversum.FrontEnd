  ...
  echo'<html>';
	...
	echo'<body>';
	   echo'<nav class="navtop">';
		  ...
		  echo'<a href="read.php"><i class="fas fa-address-book"></i>Contacts</a>';
		  echo'<a href="../p/read.php"><i class="fas fa-address-book"></i>product</a>';
		  echo'<a href="../p/read.php"><i class="fas fa-address-book"></i>Afmelden</a>';
		  echo'</div>';
		  echo' </nav>';
