...
<!------ end row ---->
  ...
  <!------  add acount   ---->
  <div class="col-12">    
     <button  onClick="handleButtonClick()">+</button> <input type="text" id="textField" value="0"></span> <button onClick="handleButtonsClick()">-</button>
  </div>
...
<div class="col-4">
  <p>Copyright ©2021 All rights reserved | This template is made with  by ahmedsy</p>
</div>
</div>
</div>
</div>
